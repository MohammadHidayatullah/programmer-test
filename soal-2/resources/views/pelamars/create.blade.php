        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('pelamars.store') }}" method="POST" enctype="multipart/form-data">
                        
                            @csrf

                            <div class="form-group">
                                <label class="font-weight-bold">Posisi Dilamar</label>
                                <input type="text" class="form-control @error('posisi') is-invalid @enderror" name="posisi" value="{{ old('posisi') }}" placeholder="Masukkan Posisi yang Dilamar">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_panggilan') is-invalid @enderror" name="nama_panggilan" value="{{ old('nama_panggilan') }}" placeholder="Masukkan Nama Panggilan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Masukkan Tampat Lahir">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('kebangsaan') is-invalid @enderror" name="kebangsaan" value="{{ old('kebangsaan') }}" placeholder="Masukkan Kebangsaan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('suku') is-invalid @enderror" name="suku" value="{{ old('suku') }}" placeholder="Masukkan Suku">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('ipk') is-invalid @enderror" name="ipk" value="{{ old('ipk') }}" placeholder="Masukkan ipk">
